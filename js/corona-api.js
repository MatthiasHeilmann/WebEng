var landkreisObjectId = '197'; //SK Manheim
...
//Instantiation of HttpClient
var client = new HttpClient();
//URL for current COVID data in a Landkreis
...
client.get(restServiceUrl, function(response) {
    ...
    for(var i = 0; i < inzidenz7Tage.length; i++) {
        ...
        //Auf Basis dieses Wertes wird abhängig der Grenzwerte die Hintergrundfarbe geaendert:
